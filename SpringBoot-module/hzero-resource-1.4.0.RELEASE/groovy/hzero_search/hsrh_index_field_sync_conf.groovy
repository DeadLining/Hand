...
databaseChangeLog(logicalFilePath: 'script/db/hsrh_index_field_sync_conf.groovy') {
    changeSet(author: "qi.liu02@hand-china.com", id: "2020-02-26-hsrh_index_field_sync_conf") {
        ...
        createTable(tableName: "hsrh_index_field_sync_conf", remarks: "索引字段同步配置表") {
            column(name: "field_sync_conf_id", type: "bigint(20)", autoIncrement: true ,   remarks: "表ID，主键")  {constraints(primaryKey: true)} 
            column(name: "index_field_id", type: "bigint(20)",  remarks: "关联索引字段表hsrh_index_field.index_field_id")  {constraints(nullable:"false")}  
            column(name: "field_mapping", type: "varchar(" + 255 * weight + ")",  remarks: "映射字段")  {constraints(nullable:"false")}  
            column(name: "sync_conf_id", type: "bigint(20)",  remarks: "关联索引同步配置表hsrh_index_sync_conf.sync_conf_id")  {constraints(nullable:"false")}  
