...
databaseChangeLog(logicalFilePath: 'script/db/hsrh_query_conf.groovy') {
    changeSet(author: "qi.liu02@hand-china.com", id: "2020-02-26-hsrh_query_conf") {
        ...
        createTable(tableName: "hsrh_query_conf", remarks: "查询配置表") {
            column(name: "config_id", type: "bigint(20)", autoIncrement: true ,   remarks: "表ID，主键。全局ID")  {constraints(primaryKey: true)} 
            ...
            column(name: "index_id", type: "bigint(20)",  remarks: "关联索引表hsrh_index.index_id")  {constraints(nullable:"false")}  
            column(name: "tenant_id", type: "bigint(20)",   defaultValue:"0",   remarks: "租户号")  {constraints(nullable:"false")}  
            column(name: "enabled_flag", type: "tinyint(1)",   defaultValue:"1",   remarks: "是否启用。1启用，0失效")  {constraints(nullable:"false")}  
