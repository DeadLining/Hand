...
databaseChangeLog(logicalFilePath: 'script/db/hsrh_index_sync_conf.groovy') {
    changeSet(author: "qi.liu02@hand-china.com", id: "2020-02-26-hsrh_index_sync_conf") {
        ...
        createTable(tableName: "hsrh_index_sync_conf", remarks: "索引同步配置表") {
            column(name: "sync_conf_id", type: "bigint(20)", autoIncrement: true ,   remarks: "表ID，主键。全局ID")  {constraints(primaryKey: true)} 
            ...
            column(name: "is_record", type: "tinyint(1)",   defaultValue:"0",   remarks: "是否记录到文件,1 启用，0 禁用")  {constraints(nullable:"false")}  
