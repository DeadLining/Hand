...
databaseChangeLog(logicalFilePath: 'script/db/hsrh_index_sync_log.groovy') {
    changeSet(author: "qi.liu02@hand-china.com", id: "2020-02-26-hsrh_index_sync_log") {
        ...
        createTable(tableName: "hsrh_index_sync_log", remarks: "同步日志表") {
            column(name: "sync_log_id", type: "bigint(20)", autoIncrement: true ,   remarks: "表ID，主键。全局ID")  {constraints(primaryKey: true)} 
            ...
            column(name: "index_id", type: "bigint(20)",  remarks: "关联版本控制表hsrh_index.index_id")  {constraints(nullable:"false")}  
