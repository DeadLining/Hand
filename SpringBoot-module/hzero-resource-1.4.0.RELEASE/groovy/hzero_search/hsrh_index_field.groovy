...
databaseChangeLog(logicalFilePath: 'script/db/hsrh_index_field.groovy') {
    changeSet(author: "qi.liu02@hand-china.com", id: "2020-02-26-hsrh_index_field") {
        ...
        createTable(tableName: "hsrh_index_field", remarks: "索引字段表") {
            column(name: "index_field_id", type: "bigint(20)", autoIncrement: true ,   remarks: "表ID，主键")  {constraints(primaryKey: true)} 
            ...
            column(name: "analyzer_flag", type: "tinyint(1)",   defaultValue:"0",   remarks: "是否分词。1分词，0不分词")  {constraints(nullable:"false")}  
            ...
            column(name: "pk_flag", type: "tinyint(1)",   defaultValue:"0",   remarks: "是否主键")  {constraints(nullable:"false")}  
