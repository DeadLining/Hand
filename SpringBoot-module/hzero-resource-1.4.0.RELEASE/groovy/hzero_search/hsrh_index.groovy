...
databaseChangeLog(logicalFilePath: 'script/db/hsrh_index.groovy') {
    changeSet(author: "qi.liu02@hand-china.com", id: "2020-02-26-hsrh_index") {
        ...
        createTable(tableName: "hsrh_index", remarks: "索引表") {
            column(name: "index_id", type: "bigint(20)", autoIncrement: true ,   remarks: "表ID，主键")  {constraints(primaryKey: true)} 
            ...
            column(name: "shards", type: "tinyint(3)",   defaultValue:"1",   remarks: "分片数量")   
            column(name: "replicas", type: "tinyint(3)",   defaultValue:"0",   remarks: "副本数量")   
            column(name: "enabled_flag", type: "tinyint(1)",  remarks: "1 启用，0 禁用 （0 代表当前索引可修改删除） 判断优先级高")  {constraints(nullable:"false")}  
