...
databaseChangeLog(logicalFilePath: 'script/db/hdtt_event_send_arch.groovy') {
    changeSet(author: "xingxing.wu@hand-china.com", id: "2019-05-13-hdtt_event_send_arch") {
        def weight = 1
        ...
        if(helper.dbType().isSupportSequence()){
            createSequence(sequenceName: 'hdtt_event_send_arch_s', startValue:"1")
        }
        createTable(tableName: "hdtt_event_send_arch", remarks: "已发消息事件归档") {
   ...
   createIndex(tableName: "hdtt_event_send_arch", indexName: "hdtt_event_send_arch_n1") {
