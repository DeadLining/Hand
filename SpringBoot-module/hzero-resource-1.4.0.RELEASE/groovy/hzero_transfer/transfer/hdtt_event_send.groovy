...
databaseChangeLog(logicalFilePath: 'script/db/hdtt_event_send.groovy') {
    changeSet(author: "xingxing.wu@hand-china.com", id: "2019-05-13-hdtt_event_send") {
        def weight = 1
        ...
        if(helper.dbType().isSupportSequence()){
            createSequence(sequenceName: 'hdtt_event_send_s', startValue:"1")
        }
        createTable(tableName: "hdtt_event_send", remarks: "待发消息事件") {
   ...
   createIndex(tableName: "hdtt_event_send", indexName: "hdtt_event_send_n1") {
            column(name: "event_type")
        }
   createIndex(tableName: "hdtt_event_send", indexName: "hdtt_event_send_n2") {
