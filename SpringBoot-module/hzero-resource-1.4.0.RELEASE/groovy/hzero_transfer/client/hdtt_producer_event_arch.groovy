...
databaseChangeLog(logicalFilePath: 'script/db/hdtt_producer_event_arch.groovy') {
    changeSet(author: "xingxing.wu@hand-china.com", id: "2019-05-08-hdtt_producer_event_arch") {
        def weight = 1
        ...
        if(helper.dbType().isSupportSequence()){
            createSequence(sequenceName: 'hdtt_producer_event_arch_s', startValue:"1")
        }
        createTable(tableName: "hdtt_producer_event_arch", remarks: "生产事件归档") {
            ...
            column(name: "service_code", type: "varchar(" + 30 * weight + ")",  remarks: "服务名")  {constraints(nullable:"false")}  
