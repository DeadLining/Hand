...
databaseChangeLog(logicalFilePath: 'script/db/hdtt_consumer_event_arch.groovy') {
    changeSet(author: "xingxing.wu@hand-china.com", id: "2019-05-08-hdtt_consumer_event_arch") {
        def weight = 1
        ...
        if(helper.dbType().isSupportSequence()){
            createSequence(sequenceName: 'hdtt_consumer_event_arch_s', startValue:"1")
        }
        createTable(tableName: "hdtt_consumer_event_arch", remarks: "消费事件归档") {
        ...
        addUniqueConstraint(columnNames:"event_id,source_service,source_table,source_key_id,process_status",tableName:"hdtt_consumer_event_arch",constraintName: "hdtt_consumer_event_arch_u1")
    }
    changeSet(author: "jianbo.li@hand-china.com",id: "2019-05-16-hdtt_consumer_event_arch-changeIndex"){
        def weight = 1
        if(helper.isSqlServer()){
            weight = 2
        } else if(helper.isOracle()){
        ...
        addColumn(tableName: "hdtt_consumer_event_arch"){
        ...
        dropUniqueConstraint(constraintName: "hdtt_consumer_event_arch_u1",tableName: "hdtt_consumer_event_arch")
        createIndex(tableName: "hdtt_consumer_event_arch",indexName:"hdtt_consumer_event_arch_n1"){
