...
databaseChangeLog(logicalFilePath: 'script/db/hivc_auth_result_detail.groovy') {
    changeSet(author: "hzero@hand-china.com", id: "2020-05-26-hivc_auth_result_detail") {
        ...
        createTable(tableName: "hivc_auth_result_detail", remarks: "发票认证统计结果") {
            ...
            column(name: "deduction_total_amount", type: "decimal",   defaultValue:"0.00",   remarks: "抵扣总金额")  {constraints(nullable:"false")}  
            column(name: "deduction_total_valid_tax", type: "decimal",   defaultValue:"0.00",   remarks: "抵扣总有效税额")  {constraints(nullable:"false")}  
            column(name: "non_deduction_invoice_num", type: "int",   defaultValue:"0",   remarks: "不抵扣发票份数")  {constraints(nullable:"false")}  
            column(name: "non_deduction_total_amount", type: "decimal",   defaultValue:"0.00",   remarks: "不抵扣总金额")  {constraints(nullable:"false")}  
            column(name: "non_deduction_total_valid_tax", type: "decimal",   defaultValue:"0.00",   remarks: "不抵扣总有效税额")  {constraints(nullable:"false")}  
