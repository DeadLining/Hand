...
databaseChangeLog(logicalFilePath: 'script/db/hivc_check_result.groovy') {
    changeSet(author: "hzero@hand-china.com", id: "2020-05-26-hivc_check_result") {
        ...
        createTable(tableName: "hivc_check_result", remarks: "查验结果") {
            ...
            column(name: "total_amount", type: "decimal",  remarks: "价税合计 15:车价合计")   
            ...
            column(name: "invoice_amount", type: "decimal",  remarks: "不含税金额")   
            column(name: "tax_amount", type: "decimal",  remarks: "税额(类型15:空)")   
            ...
            column(name: "tax_rate", type: "decimal",  remarks: "税率(03/15)")   
