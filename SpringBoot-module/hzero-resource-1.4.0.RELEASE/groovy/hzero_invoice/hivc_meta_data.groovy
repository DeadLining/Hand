...
databaseChangeLog(logicalFilePath: 'script/db/hivc_meta_data.groovy') {
    changeSet(author: "hzero@hand-china.com", id: "2020-05-26-hivc_meta_data") {
        ...
        createTable(tableName: "hivc_meta_data", remarks: "发票主数据") {
            ...
            column(name: "invoice_date", type: "date",   defaultValue:"1900-01-01",   remarks: "开票日期")  {constraints(nullable:"false")}  
            ...
            column(name: "invoice_amount", type: "decimal",   defaultValue:"0.00",   remarks: "发票金额")  {constraints(nullable:"false")}  
            column(name: "tax_amount", type: "decimal",   defaultValue:"0.00",   remarks: "发票税额")  {constraints(nullable:"false")}  
            column(name: "valid_tax_amount", type: "decimal",   defaultValue:"0.00",   remarks: "有效税额")  {constraints(nullable:"false")}  
            ...
            column(name: "tick_date", type: "date",   defaultValue:"1900-01-01",   remarks: "勾选时间")  {constraints(nullable:"false")}  
            ...
            column(name: "stock_in_date", type: "date",   defaultValue:"1900-01-01",   remarks: "入电子抵账库日期")  {constraints(nullable:"false")}  
