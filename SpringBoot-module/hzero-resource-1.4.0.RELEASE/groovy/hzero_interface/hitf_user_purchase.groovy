...
databaseChangeLog(logicalFilePath: 'script/db/hitf_user_purchase.groovy') {
    changeSet(author: "minghui.qiu@hand-china.com ", id: "2020-02-18-hitf_user_purchase") {
        ...
        createTable(tableName: "hitf_user_purchase", remarks: "用户购买记录信息") {
            column(name: "user_purchase_id", type: "bigint(20)", autoIncrement: true, remarks: "表ID，主键") { constraints(primaryKey: true) }
            ...
            column(name: "source_id", type: "bigint(20)", remarks: "来源ID") { constraints(nullable: "false") }
            ...
            column(name: "total_count", type: "bigint(20)", remarks: "总数量")
            column(name: "remain_count", type: "bigint(20)", remarks: "余量")
            column(name: "charge_uom_code", type: "varchar(" + 30 + ")", remarks: "计费单位代码")
            column(name: "next_bill_time", type: "datetime", remarks: "下一个账单时间")
            column(name: "charge_rule_id", type: "bigint(20)", remarks: "计费规则头ID") { constraints(nullable: "false") }
            column(name: "charge_rule_line_id", type: "bigint(20)", remarks: "计费规则行ID")
