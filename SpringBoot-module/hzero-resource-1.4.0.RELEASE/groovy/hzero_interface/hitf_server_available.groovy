...
databaseChangeLog(logicalFilePath: 'script/db/hitf_server_available.groovy') {
    changeSet(author: "minghui.qiu@hand-china.com ", id: "2020-02-18-hitf_server_available") {
        ...
        createTable(tableName: "hitf_server_available", remarks: "用户可用服务信息") {
            column(name: "server_available_id", type: "bigint(20)", autoIncrement: true, remarks: "表ID，主键") { constraints(primaryKey: true) }
            column(name: "user_purchase_id", type: "bigint(20)", remarks: "表hitf_user_purchase主键") { constraints(nullable: "false") }
            ...
            column(name: "interface_server_id", type: "bigint(20)", remarks: "表hitf_interface_server主键ID") { constraints(nullable: "false") }
            column(name: "interface_id", type: "bigint(20)", remarks: "表hitf_interface主键ID")
