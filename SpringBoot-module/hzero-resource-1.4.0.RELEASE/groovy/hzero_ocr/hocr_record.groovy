...
databaseChangeLog(logicalFilePath: 'script/db/hocr_record.groovy') {
    changeSet(author: "jialin.xing@hand-china.com", id: "2019-10-14-hocr_record") {
        ...
        createTable(tableName: "hocr_record", remarks: "OCR识别记录表") {
            column(name: "record_id", type: "bigint(20)", autoIncrement: true ,   remarks: "表ID，主键")  {constraints(primaryKey: true)} 
            column(name: "record_detail_id", type: "bigint(20)",   defaultValue:"0",   remarks: "记录回写ID")  {constraints(nullable:"false")}  
            ...
            column(name: "recognized_by", type: "bigint(20)",  remarks: "识别人")  {constraints(nullable:"false")}  
   ...
   createIndex(tableName: "hocr_record", indexName: "hocr_record_n1") {
    ...
    changeSet(author: "liang.li05@hand-china.com", id: "2020-04-23-hocr_record") {
        ...
        addColumn(tableName: 'hocr_record') {
            column(name: "parent_id", type: "bigint(20)", defaultValue: "", remarks: "所属多图识别记录的ID"){
                constraints(nullable: "true")
            }
            column(name: "hidden_flag", type: "tinyint(1)", defaultValue: "0", remarks: "数据是否需要被隐藏，隐藏1 展示0"){
                constraints(nullable: "true")
            }
        }

        dropNotNullConstraint(tableName: "hocr_record", columnName: "record_detail_id", columnDataType: "bigint(20)")
    }
