...
databaseChangeLog(logicalFilePath: 'script/db/hocr_vat_invoice_line.groovy') {
    changeSet(author: "jialin.xing@hand-china.com", id: "2019-10-14-hocr_vat_invoice_line") {
        ...
        createTable(tableName: "hocr_vat_invoice_line", remarks: "增值税发票识别信息行表") {
            column(name: "vat_invoice_line_id", type: "bigint(20) unsigned", autoIncrement: true ,   remarks: "")  {constraints(primaryKey: true)} 
            column(name: "vat_invoice_header_id", type: "bigint(20)",  remarks: "hocr_vat_invoice_header表主键")  {constraints(nullable:"false")}  
