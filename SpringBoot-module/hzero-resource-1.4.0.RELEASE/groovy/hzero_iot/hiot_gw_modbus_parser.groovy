...
databaseChangeLog(logicalFilePath: 'script/db/hiot_gw_modbus_parser.groovy') {
    changeSet(author: "hzero-iot@hand-china.com", id: "2019-11-25-hiot_gw_modbus_parser") {
        def weight = 1
        ...
        createTable(tableName: "hiot_gw_modbus_parser", remarks: "Modbus子设备解析配置") {
            ...
            column(name: "ORGANIZATION_ID", type: "bigint",  remarks: "组织ID, Modbus设备解析配置隔离到组织, 需要设置值")  {constraints(nullable:"false")}  
    ...
    changeSet(author:"jianming.zhong01@hand-china.com", id: "2019-12-16_hiot_gw_modbus_parser_requestInterval"){
        dropNotNullConstraint(columnDataType:"int", columnName:"REQUEST_INTERVAL", tableName:"hiot_gw_modbus_parser")
    }
}