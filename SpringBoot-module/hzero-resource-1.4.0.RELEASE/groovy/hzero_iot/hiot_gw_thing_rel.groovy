...
databaseChangeLog(logicalFilePath: 'script/db/hiot_gw_thing_rel.groovy') {
    changeSet(author: "hzero-iot@hand-china.com", id: "2019-11-25-hiot_gw_thing_rel") {
        def weight = 1
        ...
        createTable(tableName: "hiot_gw_thing_rel", remarks: "网关设备关系") {
            ...
            column(name: "ORGANIZATION_ID", type: "bigint",  remarks: "组织ID, 网关下绑定的Modbus协议设备隔离到组织, 需要设置值")  {constraints(nullable:"false")}  
