...
databaseChangeLog(logicalFilePath: 'script/db/hiot_property_type.groovy') {
    changeSet(author: "hzero-iot@hand-china.com", id: "2019-11-25-hiot_property_type") {
        def weight = 1
        ...
        createTable(tableName: "hiot_property_type", remarks: "数据点类型") {
            ...
            column(name: "ORGANIZATION_ID", type: "bigint",   defaultValue:"-1",   remarks: "组织ID, 数据点类型不隔离到组织, 使用默认值即可")  {constraints(nullable:"false")}  
