...
databaseChangeLog(logicalFilePath: 'script/db/hiot_register.groovy') {
    changeSet(author: "hzero-iot@hand-china.com", id: "2019-11-25-hiot_register") {
        def weight = 1
        ...
        createTable(tableName: "hiot_register", remarks: "注册信息") {
            ...
            column(name: "ITEM_TYPE", type: "tinyint",  remarks: "项类型, 0-设备模板,1-设备,2-网关")  {constraints(nullable:"false")}  
            column(name: "ITEM_ID", type: "bigint",  remarks: "ITEM_TYPE=0,ITEM_ID=设备模板ID,hiot_thing_model.MODEL_ID;ITEM_TYPE=1,ITEM_ID=设备ID,hiot_thing.THING_ID;ITEM_TYPE=2,ITEM_ID=网关ID,hiot_gateway.GATEWAY_ID")  {constraints(nullable:"false")}  
            ...
            column(name: "CONFIG_ID", type: "bigint",  remarks: "云配置信息")   
            column(name: "ORGANIZATION_ID", type: "bigint",  remarks: "组织ID, 网关或设备注册信息隔离到组织, 需要设置值")  {constraints(nullable:"false")}  
