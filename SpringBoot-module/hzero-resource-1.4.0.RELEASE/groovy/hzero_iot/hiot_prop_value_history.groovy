...
databaseChangeLog(logicalFilePath: 'script/db/hiot_prop_value_history.groovy') {
    changeSet(author: "hzero-iot@hand-china.com", id: "2019-11-25-hiot_prop_value_history") {
        def weight = 1
        ...
        createTable(tableName: "hiot_prop_value_history", remarks: "设备数据点上报历史记录") {
            ...
            column(name: "PROPERTY_ID", type: "bigint",  remarks: "关联对象类型, 1-数据点组, 0-数据点")  {constraints(nullable:"false")}  
            ...
            column(name: "ORGANIZATION_ID", type: "bigint",  remarks: "组织ID, 设备数据点上报历史记录隔离到组织, 需要设置值")  {constraints(nullable:"false")}  
