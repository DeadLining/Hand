...
databaseChangeLog(logicalFilePath: 'script/db/hiot_prop_value.groovy') {
    changeSet(author: "hzero-iot@hand-china.com", id: "2019-11-25-hiot_prop_value") {
        def weight = 1
        ...
        createTable(tableName: "hiot_prop_value", remarks: "设备数据点当前值") {
            ...
            column(name: "ORGANIZATION_ID", type: "bigint",  remarks: "组织ID, 设备数据点当前值隔离到组织, 需要设置值")  {constraints(nullable:"false")}  
