...
databaseChangeLog(logicalFilePath: 'script/db/hiot_gw_edgink.groovy') {
    changeSet(author: "hzero-iot@hand-china.com", id: "2019-11-25-hiot_gw_edgink") {
        def weight = 1
        ...
        createTable(tableName: "hiot_gw_edgink", remarks: "Edgink子设备") {
            ...
            column(name: "ORGANIZATION_ID", type: "bigint",  remarks: "组织ID, Edgink子设备隔离到组织, 需要设置值")  {constraints(nullable:"false")}  
