...
databaseChangeLog(logicalFilePath: 'script/db/hiot_property.groovy') {
    changeSet(author: "hzero-iot@hand-china.com", id: "2019-11-25-hiot_property") {
        def weight = 1
        ...
        createTable(tableName: "hiot_property", remarks: "数据点") {
            ...
            column(name: "PROPERTY_MODEL_ID", type: "bigint",  remarks: "数据点模板ID, hiot_thing_model.PROPERTY_MODEL_ID")  {constraints(nullable:"false")}  
            column(name: "PROPERTY_CODE", type: "varchar(" + 30 * weight + ")",  remarks: "编码")  {constraints(nullable:"false")}  
            column(name: "PROPERTY_NAME", type: "varchar(" + 45 * weight + ")",  remarks: "名称")  {constraints(nullable:"false")}  
            ...
            column(name: "MIN_VALUE", type: "double(11,2)",  remarks: "合理值范围最小值, 用于测量点, 数值型控制参数")   
            column(name: "MAX_VALUE", type: "double(11,2)",  remarks: "合理值范围最大值, 用于测量点, 数值型控制参数")   
            ...
            column(name: "ORGANIZATION_ID", type: "bigint",  remarks: "组织ID, 数据点需要隔离到组织, 需要设置值")  {constraints(nullable:"false")}  
