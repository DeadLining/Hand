...
databaseChangeLog(logicalFilePath: 'script/db/hiot_alert_summary.groovy') {
    changeSet(author: "hzero.iot@hand-china.com", id: "2019-12-20-hiot_alert_summary") {
        def weight = 1
        ...
        addUniqueConstraint(columnNames:"TENANT_ID,PROJECT_ID,SUMMARY_DATE,ALERT_LEVEL",tableName:"hiot_alert_summary",constraintName: "hiot_gw_alert_summary_u1")
    }
}