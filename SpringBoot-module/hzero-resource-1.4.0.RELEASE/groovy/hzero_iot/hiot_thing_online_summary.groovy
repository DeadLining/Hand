...
databaseChangeLog(logicalFilePath: 'script/db/hiot_thing_online_summary.groovy') {
    changeSet(author: "hzero.iot@hand-china.com", id: "2019-12-20-hiot_thing_online_summary") {
        def weight = 1
        ...
        addUniqueConstraint(columnNames:"TENANT_ID,PROJECT_ID,CATEGORY,SUMMARY_DATE",tableName:"hiot_thing_online_summary",constraintName: "hiot_thing_online_summary_u1")
    }
}